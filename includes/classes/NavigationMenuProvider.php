...
class NavigationMenuProvider{
  ...
  private $con, $userLogedInObj;

  public function __construct($con, $userLogedInObj){
    $this->con = $con;
  ...
  private function createSubscriptionsSection(){
    $subscriptions = $this->userLogedInObj->getSubscriptions();

    $html = "<span class='heading'>　登録者(Subscriptions)</span>";
